...
class Executor:
    ...
    #     # self.frame = 0 outdated
    #     # self.sendForce = False outdated
    #     # self.sendTemperature = False outdated
    #
    #     # init the data of the structure
    #     # self.all_positions = None outdated
    #     # self.all_cells = None outdated
    #     # self.all_temperatures = None outdated
    #     # self.all_elements = None outdated
    #     pass
    ...
    # def initialize_job(self): outdated
    ...
    # def on_input(self, type, val, is_test=False): outdated
    ...
    # # called from Unity, currently not used, get_structure_data is outdated
    ...
    # # get all important data of the current structure outdated
    ...
    # def get_atom_positions(self, frame=0): outdated
